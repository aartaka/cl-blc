...
(define-public sbcl-cl-blc
  (package
   ...
   (source
    ...
    ;;   (method git-fetch)
    ;;   (uri (git-reference
    ;;         (url "https://github.com/aartaka/cl-blc")
    ;;         (commit version)))
    ;;   (file-name (git-file-name "cl-cl-blc" version))
    ;;   (sha256
    ;;    (base32
    ;;     "SPECIFY-HASH")))
    )
   ...
   (home-page "https://github.com/aartaka/cl-blc")
   (description "ADD A DESCRIPTION")
   (license license:bsd-3)))

(define-public cl-cl-blc
  (sbcl-package->cl-source-package sbcl-cl-blc))

(define-public ecl-cl-blc
  (sbcl-package->ecl-package sbcl-cl-blc))
